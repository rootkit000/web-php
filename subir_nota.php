...
$consulta2="SELECT id,name,lastname,phone_number,mail,ci FROM teachers  ";
...
echo "<td >".$fila['3']."</td>";
echo "<td >".$fila['4']."</td>";
echo "<td >".$fila['5']."<form action='subir_nota2.php' method='post'><input type='text' name='teacher_id' style='display:none;' value='".$fila['0']."'><input class='btn btn-info float-md-right' type='submit' name='submit' value='siguiente'></form>  </td></tr>";
