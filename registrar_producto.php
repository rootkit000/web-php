...
<center>
<form accept-charset="utf-8" action="registro_producto.php" enctype="multipart/form-data" method="POST">
...
<br>
   ...
   <h5 class="display-5  font-weight-bolder  text-body color-dark float-md-left">Registro de productos</h5>
   <br>
...
<br>
<b>Precio</b>
<input type="text" name="price"  required placeholder="precio" class="form-control form-control-sm" />

  

<input type="file" name="imagen" required>
   <input  class="btn btn-dark float-md-right" type="submit" name="submit" value="Registrar producto"/>
